...
void initLCengine()
{
  /* I18n */
  lincity_set_locale ();
  LOGD("[Lincity]initLincity() - After lincity_set_locale()\n");
  /* Set up the paths to certain files and directories */
  init_path_strings ();
  LOGD("[Lincity]initLincity() - After init_path_strings()\n");
  /* Make sure that things are installed where they should be */
  //  verify_package ();

  /* Make sure the save directory exists */
  check_savedir ();
  LOGD("[Lincity]initLincity() - After check_savedir()\n");
  /* Load preferences */
  ...
  /* Save preferences */
    ...
    //    init_mini_map_mouse ();
    mps_init();
   LOGD("[Lincity]initLincity() - After mps_init()\n");
    //    setcustompalette ();
    //    draw_background ();
...
void initLincity()
{
    LOGD("[Lincity]initLincity() - Before initLCengine()\n");
    initLCengine();
    LOGD("[Lincity]initLincity() - After initLCengine()\n");
    // animation time
    reset_start_time ();
